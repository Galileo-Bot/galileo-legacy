...
function parseDate(pattern, date = new Date(), removeOneDay = false, options = {}) {
	...
	let result = pattern;
	result = result.replace(/y{4}/g, parts.get('year'))
...
function formatByteSize(bytes) {
	if (bytes < 1000) return `${bytes} octets`; else if (bytes < 1000000) return `${(bytes / 1000).toFixed(3)} KB`; else if (bytes < 1000000000) return `${(bytes / 1000000).toFixed(3)} MB`; else return `${(bytes / 1000000000).toFixed(3)} GB`;
}
